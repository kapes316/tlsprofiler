...
MSG_PROCESS_RETURN tls_process_server_hello(SSL *s, PACKET *pkt)
{
    ...
    memset(&_sh_data, 0x00, sizeof(_sh_data));
    ...
    //dtp
    _sh_data.version = SSL_IS_TLS13(s)?TLS1_3_VERSION:sversion;
    ...
    //dtp
    memcpy(_sh_data.cipher,cipherchars,2);
    ...
    //dtp
    memcpy(_sh_data.extensions, extpkt.curr, extpkt.remaining);
    _sh_data.extensions_len = extpkt.remaining;
...
_sh_data.version = SSL_IS_TLS13(s)?TLS1_3_VERSION:sversion; //bcm
//dtp extensions
...
MSG_PROCESS_RETURN tls_process_server_certificate(SSL *s, PACKET *pkt)
{
    ...
    //dtp
    if(_sc_data.data)free(_sc_data.data);
    memset(&_sc_data,0x00,sizeof(_sc_data));
    ...
    //dtp
    _sc_data.data = (char*)malloc(cert_list_len);
    _sc_data.len  = cert_list_len;
    memcpy(_sc_data.data,pkt->curr,cert_list_len);
