...
typedef struct ssl_sh_data
{
  unsigned int version;
  char  cipher[2];
  char  extensions[1024]; //eh
  unsigned int extensions_len;
}SSL_sh_data;

typedef struct ssl_sc_data
{
  char        *data;
  unsigned int len;
}SSL_sc_data;

void SSL_get_server_hello_data(SSL_sh_data **sh_data);
void SSL_get_server_cert_data(SSL_sc_data **sc_data);
