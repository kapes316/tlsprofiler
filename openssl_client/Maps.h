...
/* Version number */
static const std::map<uint32_t,std::string> ssl_version_tbl = 
{
    {768, "SSL 3.0"},
    {769, "TLS 1.0"},
    {770, "TLS 1.1"},
...
static const std::map<uint32_t,std::string> ssl_exts_tbl =
{
    ...
    {TLSEXT_TYPE_application_layer_protocol_negotiation, "application_layer_protocol_negotiation"},
